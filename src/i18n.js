...
const translations = {
  fr: {
    ...
    navHome: 'Accueil', navSkills: 'Compétences', navContact: 'Contact',
    ...
    testimonialsGiveReview: 'Donner mon avis',
    testimonialsReviewsCount: 'avis',
    testimonialsNoReviews: 'Aucun avis pour le moment.',
    reviewFormTitle: 'Donner mon avis',
    reviewFormDesc: 'Partage ton expérience de travail avec moi.',
    reviewFormName: 'Nom',
    reviewFormNamePlaceholder: 'Votre nom',
    reviewFormContext: 'Contexte (optionnel)',
    reviewFormContextPlaceholder: 'Ex : Client, Collègue...',
    reviewFormRating: 'Note',
    reviewFormMessage: 'Votre avis',
    reviewFormMessagePlaceholder: 'Racontez votre expérience...',
    reviewFormNote: 'Ton avis me sera envoyé pour validation avant publication sur le site.',
    reviewFormSubmit: 'Envoyer mon avis',
  ...
  en: {
    ...
    aboutLink: 'About Me',
    navHome: 'Home', navSkills: 'Skills', navContact: 'Contact',
    aboutPrefix: 'About',
    aboutTitle: 'Me',
    ...
    testimonialsPosition: 'Collaboration',
    testimonialsGiveReview: 'Give my review',
    testimonialsReviewsCount: 'reviews',
    testimonialsNoReviews: 'No reviews yet.',
    reviewFormTitle: 'Give my review',
    reviewFormDesc: 'Share your experience working with me.',
    reviewFormName: 'Name',
    reviewFormNamePlaceholder: 'Your name',
    reviewFormContext: 'Context (optional)',
    reviewFormContextPlaceholder: 'E.g. Client, Colleague...',
    reviewFormRating: 'Rating',
    reviewFormMessage: 'Your review',
    reviewFormMessagePlaceholder: 'Tell us about your experience...',
    reviewFormNote: 'Your review will be sent to me for approval before it appears on the site.',
    reviewFormSubmit: 'Send my review',
  ...
  de: {
    ...
    aboutLink: 'Über mich',
    navHome: 'Start', navSkills: 'Skills', navContact: 'Kontakt',
    aboutPrefix: 'Über',
    aboutTitle: 'mich',
    ...
    testimonialsGiveReview: 'Bewertung abgeben',
    testimonialsReviewsCount: 'Bewertungen',
    testimonialsNoReviews: 'Noch keine Bewertungen.',
    reviewFormTitle: 'Bewertung abgeben',
    reviewFormDesc: 'Teile deine Erfahrung der Zusammenarbeit mit mir.',
    reviewFormName: 'Name',
    reviewFormNamePlaceholder: 'Dein Name',
    reviewFormContext: 'Kontext (optional)',
    reviewFormContextPlaceholder: 'z. B. Kunde, Kollege...',
    reviewFormRating: 'Bewertung',
    reviewFormMessage: 'Deine Bewertung',
    reviewFormMessagePlaceholder: 'Erzähl von deiner Erfahrung...',
    reviewFormNote: 'Deine Bewertung wird mir zur Prüfung gesendet, bevor sie auf der Website erscheint.',
