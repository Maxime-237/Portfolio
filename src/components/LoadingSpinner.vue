<template>
  <div class="flex justify-center items-center h-screen bg-linear-to-r from-gray-900 via-slate-900 to-gray-900">
    ...
    <div class="text-center">
        <div class="flex space-x-2 mb-4">
            ...
            <div class="w-3 h-3 bg-amber-400 rounded-full animate-bounce" style="animation-delay: 0.3s;"></div>
        </div>
    </div>
  </div>
</template>
